...
plot_fields('Predicted', tgt.points, pred.u[0], pred.p[0], tgt.zones_ids)
plot_fields('Ground truth', tgt.points, tgt.pde.u, tgt.pde.p, tgt.zones_ids)

plt.interactive(False)

u_error = pred.u[0] - tgt.pde.u
p_error = pred.p[0] - tgt.pde.p
plot_fields('Absolute error', tgt.points, np.abs(u_error), np.abs(p_error), tgt.zones_ids, plot_streams=False)
