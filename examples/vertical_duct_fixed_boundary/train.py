...
if __name__ == '__main__':
    ...
    train_data = VerticalDuctDataset(args.train_dir, n_internal, n_boundary, n_obs, rng=rng,regions_weights=region_weights)
    val_data = VerticalDuctDataset(args.val_dir, n_internal, n_boundary, n_obs, rng=rng, meta_dir=args.train_dir,regions_weights=region_weights)

    model = type(get_model(args.model, train_data.normalizers)).load_from_checkpoint(args.checkpoint)
